...
KElement has method to download file. Example:
...
It’s possible to set custom output folder:

----
kirk.output=c:\\output\     //default  .\build\download\
----

*Note:* output path should be absolute
